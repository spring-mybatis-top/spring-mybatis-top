  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2
          id="sampleProjectMysqlApp.employee.home.createOrEditLabel"
          data-cy="EmployeeCreateUpdateHeading"
          v-text="$t('sampleProjectMysqlApp.employee.home.createOrEditLabel')"
        >
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('sampleProjectMysqlApp.employee.empName')" for="employee-empName">Emp Name</label>
            <input
              type="text"
              class="form-control"
              name="empName"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('sampleProjectMysqlApp.employee.salary')" for="employee-salary">Salary</label>
            <input
              type="number"
              class="form-control"
              name="salary"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('sampleProjectMysqlApp.employee.myDept')" for="employee-myDept">My Dept</label>
