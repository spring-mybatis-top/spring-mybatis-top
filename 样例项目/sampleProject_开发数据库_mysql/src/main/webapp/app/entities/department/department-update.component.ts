    ...
    if (this.department.id) {
      this.departmentService()
        ...
        .then(param => {
          this.isSaving = false;
          this.$router.go(-1);
          const message = this.$t('sampleProjectMysqlApp.department.updated', { param: param.id });
      ...
      this.departmentService()
        ...
        .then(param => {
          this.isSaving = false;
          this.$router.go(-1);
          const message = this.$t('sampleProjectMysqlApp.department.created', { param: param.id });
