...
import com.spring_mybatis.top.helloworld.domain.Employee;
import com.spring_mybatis.top.helloworld.domain.EmployeeExample;
import com.spring_mybatis.top.helloworld.domain.EmployeeMapper;
...
/**
 * REST controller for managing {@link com.spring_mybatis.top.helloworld.domain.Employee}.
 */
@RestController
@RequestMapping("/api")
@Transactional
