...
export default class Info extends mixins(JhiDataUtils) {
  ...
  public prepareRemove(instance: IInfo): void {
  ...
  public removeInfo(): void {
    this.infoService()
      ...
      .then(() => {
        const message = this.$t('sampleProjectAllFildApp.info.deleted', { param: this.removeId });
