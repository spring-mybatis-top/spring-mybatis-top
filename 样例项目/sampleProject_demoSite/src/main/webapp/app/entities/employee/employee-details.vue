    ...
    <div class="col-8">
      <div v-if="employee">
        <h2 class="jh-entity-heading" data-cy="employeeDetailsHeading">
          <span v-text="$t('sampleProjectAllFildApp.employee.detail.title')">Employee</span> {{ employee.id }}
        </h2>
        <dl class="row jh-entity-details">
          ...
          <dt>
            <span v-text="$t('sampleProjectAllFildApp.employee.myDept')">My Dept</span>
          </dt>
          <dd>
