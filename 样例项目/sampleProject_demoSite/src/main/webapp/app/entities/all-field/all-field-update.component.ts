    ...
    if (this.allField.id) {
      this.allFieldService()
        ...
        .then(param => {
          this.isSaving = false;
          this.$router.go(-1);
          const message = this.$t('sampleProjectAllFildApp.allField.updated', { param: param.id });
      ...
      this.allFieldService()
        ...
        .then(param => {
          this.isSaving = false;
          this.$router.go(-1);
          const message = this.$t('sampleProjectAllFildApp.allField.created', { param: param.id });
