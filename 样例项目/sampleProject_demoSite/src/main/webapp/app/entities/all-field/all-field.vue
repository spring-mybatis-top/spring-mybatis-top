<template>
  <div>
    <h2 id="page-heading" data-cy="AllFieldHeading">
      <span v-text="$t('sampleProjectAllFildApp.allField.home.title')" id="all-field-heading">All Fields</span>
      <div class="d-flex justify-content-end">
        <button class="btn btn-info mr-2" v-on:click="handleSyncList" :disabled="isFetching">
          <font-awesome-icon icon="sync" :spin="isFetching"></font-awesome-icon>
          <span v-text="$t('sampleProjectAllFildApp.allField.home.refreshListLabel')">Refresh List</span>
        </button>
        <router-link :to="{ name: 'AllFieldCreate' }" custom v-slot="{ navigate }">
          ...
          >
            ...
            <span v-text="$t('sampleProjectAllFildApp.allField.home.createLabel')"> Create a new All Field </span>
          </button>
        </router-link>
      </div>
    </h2>
    ...
    <div class="alert alert-warning" v-if="!isFetching && allFields && allFields.length === 0">
      <span v-text="$t('sampleProjectAllFildApp.allField.home.notFound')">No allFields found</span>
    </div>
      ...
      <table class="table table-striped" aria-describedby="allFields">
        <thead>
          <tr>
            ...
            <th scope="row"><span v-text="$t('sampleProjectAllFildApp.allField.name')">Name</span></th>
            <th scope="row"><span v-text="$t('sampleProjectAllFildApp.allField.nameInteger')">Name Integer</span></th>
            <th scope="row"><span v-text="$t('sampleProjectAllFildApp.allField.nameLong')">Name Long</span></th>
            <th scope="row"><span v-text="$t('sampleProjectAllFildApp.allField.nameBigDecimal')">Name Big Decimal</span></th>
            <th scope="row"><span v-text="$t('sampleProjectAllFildApp.allField.nameFloat')">Name Float</span></th>
            <th scope="row"><span v-text="$t('sampleProjectAllFildApp.allField.nameDouble')">Name Double</span></th>
            <th scope="row"><span v-text="$t('sampleProjectAllFildApp.allField.nameBoolean')">Name Boolean</span></th>
            <th scope="row"><span v-text="$t('sampleProjectAllFildApp.allField.nameLocalDate')">Name Local Date</span></th>
            <th scope="row"><span v-text="$t('sampleProjectAllFildApp.allField.nameZonedDateTime')">Name Zoned Date Time</span></th>
            <th scope="row"><span v-text="$t('sampleProjectAllFildApp.allField.nameInstant')">Name Instant</span></th>
            <th scope="row"><span v-text="$t('sampleProjectAllFildApp.allField.nameBlob')">Name Blob</span></th>
            <th scope="row"><span v-text="$t('sampleProjectAllFildApp.allField.nameAnyBlob')">Name Any Blob</span></th>
            <th scope="row"><span v-text="$t('sampleProjectAllFildApp.allField.nameImageBlob')">Name Image Blob</span></th>
            <th scope="row"><span v-text="$t('sampleProjectAllFildApp.allField.nameTextBlob')">Name Text Blob</span></th>
            <th scope="row"></th>
          </tr>
        </thead>
        <tbody>
    ...
    <b-modal ref="removeEntity" id="removeEntity">
      <span slot="modal-title"
        ><span
          id="sampleProjectAllFildApp.allField.delete.question"
          data-cy="allFieldDeleteDialogHeading"
          v-text="$t('entity.delete.title')"
          >Confirm delete operation</span
        ></span
      >
      <div class="modal-body">
        <p id="jhi-delete-allField-heading" v-text="$t('sampleProjectAllFildApp.allField.delete.question', { id: removeId })">
