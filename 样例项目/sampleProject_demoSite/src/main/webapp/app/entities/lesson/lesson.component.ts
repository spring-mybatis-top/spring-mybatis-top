...
export default class Lesson extends mixins(JhiDataUtils) {
  ...
  public retrieveAllLessons(): void {
  ...
  public prepareRemove(instance: ILesson): void {
  ...
  public removeLesson(): void {
    this.lessonService()
      ...
      .then(() => {
        const message = this.$t('sampleProjectAllFildApp.lesson.deleted', { param: this.removeId });
