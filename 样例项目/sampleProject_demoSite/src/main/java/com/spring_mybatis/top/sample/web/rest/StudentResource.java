...
import com.spring_mybatis.top.sample.domain.LessonMapper;
import com.spring_mybatis.top.sample.domain.RelStudentMylesn;
import com.spring_mybatis.top.sample.domain.RelStudentMylesnExample;
import com.spring_mybatis.top.sample.domain.RelStudentMylesnKey;
import com.spring_mybatis.top.sample.domain.RelStudentMylesnMapper;
import com.spring_mybatis.top.sample.domain.Student;
import com.spring_mybatis.top.sample.domain.StudentExample;
import com.spring_mybatis.top.sample.domain.StudentMapper;
...
/**
 * REST controller for managing {@link com.spring_mybatis.top.sample.domain.Student}.
 */
@RestController
@RequestMapping("/api")
@Transactional
