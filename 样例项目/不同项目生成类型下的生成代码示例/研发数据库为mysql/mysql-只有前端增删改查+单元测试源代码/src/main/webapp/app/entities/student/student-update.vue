  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2
          id="sampleProjectMysqlApp.student.home.createOrEditLabel"
          data-cy="StudentCreateUpdateHeading"
          v-text="$t('sampleProjectMysqlApp.student.home.createOrEditLabel')"
        >
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('sampleProjectMysqlApp.student.stuName')" for="student-stuName">Stu Name</label>
            <input
              type="text"
              class="form-control"
              name="stuName"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('sampleProjectMysqlApp.student.money')" for="student-money">Money</label>
            <input
              type="number"
              class="form-control"
              name="money"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('sampleProjectMysqlApp.student.language')" for="student-language">Language</label>
            <select
              class="form-control"
              name="language"
            ...
            >
              <option
                ...
                v-bind:label="$t('sampleProjectMysqlApp.Language.' + language)"
              >
                {{ language }}
              </option>
            </select>
          ...
          <div class="form-group">
            <label v-text="$t('sampleProjectMysqlApp.student.mylesn')" for="student-mylesn">Mylesn</label>
            <select
              class="form-control"
              id="student-mylesns"
              data-cy="mylesn"
