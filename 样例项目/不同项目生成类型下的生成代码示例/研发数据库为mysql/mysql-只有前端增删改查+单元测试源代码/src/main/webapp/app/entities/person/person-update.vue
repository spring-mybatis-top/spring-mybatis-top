  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2
          id="sampleProjectMysqlApp.person.home.createOrEditLabel"
          data-cy="PersonCreateUpdateHeading"
          v-text="$t('sampleProjectMysqlApp.person.home.createOrEditLabel')"
        >
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('sampleProjectMysqlApp.person.personName')" for="person-personName"
              >Person Name</label
            >
            <input
              type="text"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('sampleProjectMysqlApp.person.age')" for="person-age">Age</label>
            <input
              type="number"
              class="form-control"
              name="age"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('sampleProjectMysqlApp.person.myinfo')" for="person-myinfo">Myinfo</label>
