  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2
          id="sampleProjectMysqlApp.department.home.createOrEditLabel"
          data-cy="DepartmentCreateUpdateHeading"
          v-text="$t('sampleProjectMysqlApp.department.home.createOrEditLabel')"
        >
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('sampleProjectMysqlApp.department.deptName')" for="department-deptName"
              >Dept Name</label
            >
            <input
              type="text"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('sampleProjectMysqlApp.department.empNo')" for="department-empNo">Emp No</label>
            <input
              type="number"
              class="form-control"
              name="empNo"
