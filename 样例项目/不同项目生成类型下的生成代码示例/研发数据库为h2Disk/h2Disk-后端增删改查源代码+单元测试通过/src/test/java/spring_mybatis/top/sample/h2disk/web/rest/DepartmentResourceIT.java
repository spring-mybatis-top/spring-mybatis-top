...
import spring_mybatis.top.sample.h2disk.IntegrationTest;
import spring_mybatis.top.sample.h2disk.domain.Department;
import spring_mybatis.top.sample.h2disk.domain.DepartmentExample;
import spring_mybatis.top.sample.h2disk.domain.DepartmentMapper;
...
class DepartmentResourceIT {
    ...
    private static final Integer DEFAULT_EMP_NO = 1;
    private static final Integer UPDATED_EMP_NO = 2;
    ...
    public static Department createEntity() {
        ...
        department.setDeptName(DEFAULT_DEPT_NAME);
        department.setEmpNo(DEFAULT_EMP_NO);
        return department;
    }
    ...
    public static Department createUpdatedEntity() {
        Department department = new Department();
        department.setDeptName(UPDATED_DEPT_NAME);
        department.setEmpNo(UPDATED_EMP_NO);
        return department;
    }
    ...
    void createDepartment() throws Exception {
        int databaseSizeBeforeCreate = departmentMapper.selectByExample(new DepartmentExample()).size();
        ...
        assertThat(testDepartment.getEmpNo()).isEqualTo(DEFAULT_EMP_NO);
    }
    ...
    void checkDeptNameIsRequired() throws Exception {
        int databaseSizeBeforeTest = departmentMapper.selectByExample(new DepartmentExample()).size();
        // set the field null
    ...
    void putNewDepartment() throws Exception {
        ...
        int databaseSizeBeforeUpdate = departmentMapper.selectByExample(new DepartmentExample()).size();

        // Update the department
        Department updatedDepartment = departmentMapper.selectByPrimaryKey(department.getId());
        updatedDepartment.deptName(UPDATED_DEPT_NAME).empNo(UPDATED_EMP_NO);
        ...
        assertThat(testDepartment.getEmpNo()).isEqualTo(UPDATED_EMP_NO);
    }
    ...
    void deleteDepartment() throws Exception {
        ...
        int databaseSizeBeforeDelete = departmentMapper.selectByExample(new DepartmentExample()).size();
