...
import spring_mybatis.top.sample.h2disk.domain.LessonMapper;
import spring_mybatis.top.sample.h2disk.domain.RelStudentMylesn;
import spring_mybatis.top.sample.h2disk.domain.RelStudentMylesnExample;
import spring_mybatis.top.sample.h2disk.domain.RelStudentMylesnKey;
import spring_mybatis.top.sample.h2disk.domain.RelStudentMylesnMapper;
import spring_mybatis.top.sample.h2disk.domain.Student;
import spring_mybatis.top.sample.h2disk.domain.StudentExample;
import spring_mybatis.top.sample.h2disk.domain.StudentMapper;
...
/**
 * REST controller for managing {@link spring_mybatis.top.sample.h2disk.domain.Student}.
 */
@RestController
@RequestMapping("/api")
@Transactional
