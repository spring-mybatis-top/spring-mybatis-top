  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2
          id="sampleProjectH2DiskApp.employee.home.createOrEditLabel"
          data-cy="EmployeeCreateUpdateHeading"
          v-text="$t('sampleProjectH2DiskApp.employee.home.createOrEditLabel')"
        >
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('sampleProjectH2DiskApp.employee.empName')" for="employee-empName">Emp Name</label>
            <input
              type="text"
              class="form-control"
              name="empName"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('sampleProjectH2DiskApp.employee.salary')" for="employee-salary">Salary</label>
            <input
              type="number"
              class="form-control"
              name="salary"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('sampleProjectH2DiskApp.employee.myDept')" for="employee-myDept">My Dept</label>
