  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2
          id="sampleProjectH2DiskApp.info.home.createOrEditLabel"
          data-cy="InfoCreateUpdateHeading"
          v-text="$t('sampleProjectH2DiskApp.info.home.createOrEditLabel')"
        >
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('sampleProjectH2DiskApp.info.comments')" for="info-comments">Comments</label>
            <input
              type="text"
              class="form-control"
              name="comments"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('sampleProjectH2DiskApp.info.image')" for="info-image">Image</label>
            <input
              type="text"
              class="form-control"
              name="image"
