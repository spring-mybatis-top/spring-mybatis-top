...
public class AllField {
    ...
    @NotNull
    @Pattern(regexp = "^[a-z]+$")
    private String allLowercaseRegex;
    ...
    public String getAllLowercaseRegex() {
        return this.allLowercaseRegex;
    }

    public AllField allLowercaseRegex(String allLowercaseRegex) {
        this.setAllLowercaseRegex(allLowercaseRegex);
        return this;
    }

    public void setAllLowercaseRegex(String allLowercaseRegex) {
        this.allLowercaseRegex = allLowercaseRegex;
    }
    ...
    public String toString() {
        return "AllField{" +
            "id=" + getId() +
            ", allLowercaseRegex='" + getAllLowercaseRegex() + "'" +
