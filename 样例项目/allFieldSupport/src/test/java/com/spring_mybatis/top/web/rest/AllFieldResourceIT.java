...
package com.spring_mybatis.top.web.rest;

import static com.spring_mybatis.top.web.rest.TestUtil.sameInstant;
import static com.spring_mybatis.top.web.rest.TestUtil.sameNumber;
import static org.assertj.core.api.Assertions.assertThat;
import static org.hamcrest.Matchers.hasItem;
import static org.springframework.test.web.servlet.request.MockMvcRequestBuilders.*;
import static org.springframework.test.web.servlet.result.MockMvcResultMatchers.*;

import com.spring_mybatis.top.IntegrationTest;
import com.spring_mybatis.top.domain.AllFieldExample;
import com.spring_mybatis.top.domain.AllFieldMapper;
...
class AllFieldResourceIT {
    ...
    private static final String DEFAULT_ALL_LOWERCASE_REGEX = "vzz";
    private static final String UPDATED_ALL_LOWERCASE_REGEX = "islfcx";
    ...
    public static AllFieldWithBLOBs createEntity() {
        ...
        allFieldWithBLOBs.setAllLowercaseRegex(DEFAULT_ALL_LOWERCASE_REGEX);
    ...
    public static AllFieldWithBLOBs createUpdatedEntity() {
        AllFieldWithBLOBs allFieldWithBLOBs = new AllFieldWithBLOBs();
        allFieldWithBLOBs.setAllLowercaseRegex(UPDATED_ALL_LOWERCASE_REGEX);
    ...
    void createAllField() throws Exception {
        ...
        assertThat(testAllField.getAllLowercaseRegex()).isEqualTo(DEFAULT_ALL_LOWERCASE_REGEX);
    ...
    @Test
    @Transactional
    void checkAllLowercaseRegexIsRequired() throws Exception {
        int databaseSizeBeforeTest = allFieldMapper.selectByExampleWithBLOBs(new AllFieldExample()).size();
        // set the field null
        allFieldWithBLOBs.setAllLowercaseRegex(null);
    ...
    void getAllAllFields() throws Exception {
        ...
        restAllFieldMockMvc
            ...
            .andExpect(jsonPath("$.[*].allLowercaseRegex").value(hasItem(DEFAULT_ALL_LOWERCASE_REGEX)))
    ...
    void getAllField() throws Exception {
        ...
        restAllFieldMockMvc
            ...
            .andExpect(jsonPath("$.allLowercaseRegex").value(DEFAULT_ALL_LOWERCASE_REGEX))
    ...
    void putNewAllField() throws Exception {
        ...
        updatedAllField
            .allLowercaseRegex(UPDATED_ALL_LOWERCASE_REGEX)
        ...
        AllFieldWithBLOBs testAllField = allFieldList.get(allFieldList.size() - 1);
        assertThat(testAllField.getAllLowercaseRegex()).isEqualTo(UPDATED_ALL_LOWERCASE_REGEX);
